...
$sentencia = $base_de_datos->prepare("SELECT * FROM info_actor2 WHERE id = ?;");
...
<nav class="navbar navbar-default">
  <div class="container">
	...
	<form method="post" action="guardarDatosEditados.php">
		...
		<br>
		<input value="<?php echo $persona->nombre_actor ?>" name="nombre" required type="text" id="nombre" placeholder="Escribe el nombre del actor.">
		<br><br>
		<label for="apellidos">Apellidos:</label>
		<br>
		<input value="<?php echo $persona-> apellidos_actor ?>" name="apellidos" required type="text" id="apellidos" placeholder="Escribe los apellidos del actor.">
		<br><br>
		<label for="edad">Edad:</label>
		<br>
		<input value="<?php echo $persona-> edad_actor ?>" name="edad" required type="text" id="edad" placeholder="Escribe la edad del actor.">
		<br><br>
		...
		<select name="sexo" required name="sexo" id="sexo">
			...
			<option <?php echo $persona-> sexo_Actor === 'M' ? "selected='selected'": "" ?> value="M">Masculino</option>
			<option <?php echo $persona-> sexo_Actor === 'F' ? "selected='selected'": "" ?> value="F">Femenino</option>
		</select>
		<br><br><input type="submit" value="Guardar cambios">
	</form>
	<br>
	<img src="Images/stranger_banner2.jpg" class="img-responsive margin" style="width:100%" alt="Images">
	<br>
	<!-- Footer -->
